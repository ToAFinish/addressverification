({	
    ...
    saveAddressAfterSucess : function(component, event, helper) { 
        ...
        component.set('v.AddressString',theaddresses);

        
        //VG-27/11/2025- Commenting the update address code to move this component before object creation.
    ...
    populateAddress : function(component) {
